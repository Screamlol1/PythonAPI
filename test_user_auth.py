...
class TestUserAuth:
    ...
    def test_user_auth_data(self):
        ...
        assert "x-csrf-token" in response1.headers, "There is no token in response"
        ...
        assert 'user_id' in response2.json(), "There no user id in the second response"
